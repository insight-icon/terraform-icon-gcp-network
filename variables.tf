...
variable "cloudflare_enable" {
  description = "Bool to enable dns subdomain from cloudflare"
  type        = bool
  default     = false
}
...
variable "citizen_enabled" {
  description = "Boolean to for application api for citizen group traffic"
  type        = bool
  default     = false
}
...
variable "k8s_enabled" {
  description = "Boolean to enable k8s"
  type        = bool
  default     = false
}
...
variable "prep_enabled" {
  description = "Boolean to allow P-Rep related traffic"
  type        = bool
  default     = false
}
...
variable "prep_sg_name" {
  description = "Name for the prep security group"
  type        = string
  default     = "prep-sg"
}
